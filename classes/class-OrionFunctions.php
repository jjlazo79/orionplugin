...
<?php
    ...
    /**
     * Add employed public fronted information
     *
     * @param string $author
     * @return string
     */
    public function orion_ameliaemployees_public_profile($author)
    {

        $curauth = (isset($_GET['author_name'])) ? get_user_by('name', $author) : get_userdata(intval($author));
